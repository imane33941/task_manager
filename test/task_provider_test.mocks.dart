...
class MockTaskRepository extends _i1.Mock implements _i2.TaskRepository {
  @override
  _i3.Future<List<_i4.Task>> getAll() => (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [],
        ),
  ...
  @override
  _i3.Future<void> add(_i4.Task? task) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [task],
        ),
  ...
  @override
  _i3.Future<void> update(_i4.Task? task) => (super.noSuchMethod(
        Invocation.method(
          #update,
          [task],
        ),
